...
if(wordpattern) {wordpattern="pattern";} else {wordpattern="fullword";}


$.ajax({
type: 'POST',
url: './pagination.php',
data: {wordpattern:wordpattern,language:language, word:word } // getting filed value in serialize form
})
...
data: { versetotal:versetotal,system:system } // getting filed value in serialize form
})
...
data: { ultraversetotal:ultraversetotal,system:system } // getting filed value in serialize form
})
...
data: { methodversetotal:methodversetotal,system:system,totalmethodoptions:totalmethodoptions } // getting filed value in serialize form
})
...
data: { keyid:keyid, system:system } // getting filed value in serialize form
})
...
<div class="systemoptions">
 <select id="system" name="system" class="form-control">
	...
	<option value="theholybibleone#methods_one">ord + sta </option>
		  <option value="theholybibletwo#methods_two">red + ord + sta</option>
		    <option value="theholybiblethree#methods_three">Full ord + Full sta</option>
			  <option value="theholybiblefour#methods_four">Full red + Full ord + Full sta</option>
			    <option value="theholybiblefive#methods_five">rev ord + rev sta</option>
				  <option value="theholybiblesix#methods_six">rev red + rev ord + rev sta</option>
...
<form class="form-inlines" method="POST" name="verserotator" id="verserotator" action="./querywordtable.php">
 ...
 <select id="language" name="language" class="form-control">
  ...
  <label for="checkboxes-0" style="color: #ffa500;margin-top: -15px;font-size: 16px;">
      <input type="checkbox" name="wordpattern" id="wordpattern" checked="true" >
     Whole Word Only
    </label>
	</div>
