...
// DEBUG LOGGING
echo "<script>console.log('NEXT.PHP DEBUG:');</script>";
...
echo "<script>console.log('NEXT.PHP: Using bibletable:', '" . $bibletable . "');</script>";
...
echo "<script>console.log('NEXT.PHP QUERY DEBUG:');</script>";
