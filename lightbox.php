...
<div class="form-group">
  ...
  <div class="col-md-4">
  <input id="word" name="word" value="<?php echo $word;?>" type="text" placeholder="WORD" class="form-control input-md">
...
<div class="form-group">
  ...
  <div class="col-md-4">
  <input id="value" name="value" value="<?php echo $value;?>" type="text" placeholder="VALUE" class="form-control input-md" readonly>
