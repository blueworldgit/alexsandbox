...
<!-- Form Name -->
<legend>Enter a number between 1 and 39 for a book. </legend>

<!-- Text input-->
<div class="form-group">
  <label class="col-md-4 control-label" for="book"></label>  
  <div class="col-md-4">
  <input id="book" name="book" type="text" placeholder="BOOK" class="form-control input-md">
