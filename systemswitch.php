...
//$bibletable=$_POST['system'];
//$bibletable='theholybible';
...
?>
        ...
        <div class="row">
		  ...
		  <p style="text-align:center; color:#ffffff;font-size: 15px;">Verse# = <?php echo $keyvalue;?>	&nbsp;	&nbsp; Nr.W = <?php echo $no_words;?>	&nbsp;	&nbsp; Nr.L =  <?php echo $no_letters;?></p>	
...
<?php } // End Hebrew/Greek database section ?>
